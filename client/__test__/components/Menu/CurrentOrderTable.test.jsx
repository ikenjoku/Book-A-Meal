...
describe('Menu: CurrentOrderTable Component', () => {
  ...
  const userId = 1;
  const getAllPreviousOrders = jest.fn();
  ...
  test('should handleOrderUpdate  when update button is clicked', () => {
    ...
    const handleOrderUpdateSpy = jest.spyOn(wrapper.instance(), 'handleOrderUpdate');
  ...
  test('should close update modal when No button is clicked', () => {
    ...
    const closeUpdateModalSpy = jest.spyOn(wrapper.instance(), 'closeUpdateModal');
  ...
  test('should openCancelModal when cancel button is clicked', () => {
    ...
    const openCancelModalSpy = jest.spyOn(wrapper.instance(), 'openCancelModal');
  ...
  test('should close order-cancel modal when No button is clicked', () => {
    ...
    const closeCancelModalSpy = jest.spyOn(wrapper.instance(), 'closeCancelModal');
