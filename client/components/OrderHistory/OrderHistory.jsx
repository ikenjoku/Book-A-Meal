...
// import { getOrdersByDate, deliverAnOrder } from "../../actions/orderActions";
...
//         <OrderList orders={this.props.orders} deliverAnOrder={(id) => this.props.deliverAnOrder(id) }/>
//         : ''}
//       </main>
//     );
//   }
...
//   bindActionCreators({ getOrdersByDate, deliverAnOrder }, dispatch);
